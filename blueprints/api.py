...
from models import MappingModel, ProposalModel, CacheModel
from rate_limiter import sparql_rate_limit, submission_rate_limit, general_rate_limit
from monitoring import monitor_performance
from schemas import (
    MappingSchema, ProposalSchema, CheckEntrySchema,
...
def check_entry():
    ...
    try:
        ...
        # Validate input data
        is_valid, validated_data, errors = validate_request_data(CheckEntrySchema, check_data)
...
def submit():
    ...
    try:
        ...
        # Validate input data
        is_valid, validated_data, errors = validate_request_data(MappingSchema, submit_data)
            ...
            results = [
                {
                    ...
                    "pathwayDescription": binding.get("pathwayDescription", {}).get("value", "")
                }
                for binding in data["results"]["bindings"]

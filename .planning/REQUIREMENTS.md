...
- [x] **DEPLOY-02**: Embedding files migrated from pickle/dict format to NPZ matrix format
- [x] **DEPLOY-03**: Automated database backup mechanism in place before external users can modify data
- [x] **DEPLOY-04**: Embedding vectors normalized at precompute time; dot product replaces cosine similarity at query time (closes #65)
...
- [x] **EXPRT-04**: Dataset published on Zenodo with a DOI for use as a publication citation

...
- [ ] **ASMT-08**: Bulk export SELECT for `get_all_mappings` (KE-WP) and the Reactome equivalent include the new columns — explicit guard against the 4th-recurrence SELECT drift pattern.
